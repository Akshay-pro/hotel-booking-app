...
const GuestInfoForm = ({hotelId, pricePerNight} : Props) => {
    ...
    const onSignInButton = (data:GuestInfoFormData) => {
    ...
    return (
        <div className="flex flex-col p-4 bg-blue-200">
            <h3 className="text-md font-bold my-2">Rs. {pricePerNight}</h3>
            <form onSubmit={isLoggedIn? handleSubmit(onSubmit): handleSubmit(onSignInButton)}>
