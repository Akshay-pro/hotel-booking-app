...
type Props = {
    ...
    paymentIntent: PaymentIntentReponse;
};
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-2 gap-6">
                <label htmlFor="text-gray-700 text-sm font-bold flex-1">
                    First Name
                    <input
                        type="text"
                        className="mt-1 border rounded w-full p-2 text-gray-700 font-normal"
                        readOnly
                        disabled
                        {...register("firstName")}
                    />
